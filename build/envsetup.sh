...
function crescenceremote()
{
    ...
    if [ -z "$CRESCENCE_USER" ]
    then
        git remote add crescence ssh://review.crescence-review.lunia0251.moe:29418/$PFX$PROJECT
    else
        git remote add crescence ssh://$CRESCENCE_USER@review.crescence-review.lunia0251.moe:29418/$PFX$PROJECT
    fi
